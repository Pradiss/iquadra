...
export default function ConfiguracoesPage() {
  ...
  // const isProfessor = !!usuario?.perfil_professor;
  // const isAdmin = !!usuario?.academias?.length;
      ...
      <section className="mx-auto max-w-3xl">
        ...
        {usuario && (
          <div className="mt-3 space-y-5">
            ...
            {/* {isProfessor && <ConfigProfessor usuario={usuario} />}

            {isAdmin && <ConfigAdmin usuario={usuario} />} */}
          </div>
        )}
      </section>
    </LayoutPainel>
